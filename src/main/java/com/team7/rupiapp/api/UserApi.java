...
public interface UserApi {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(
                    responseCode = "422",
                    description = "Validation failed due to missing or invalid input.",
                    content = @Content(
                            mediaType = MediaType.APPLICATION_JSON_VALUE,
                            examples = @ExampleObject(
                                    value = """
    ...
    public ResponseEntity<Object> verifyPassword(Principal principal, @RequestBody UserVerifyPasswordDto userVerifyPasswordDto);
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(
                    responseCode = "400",
                    description = "Bad Request due to invalid signature or other validation errors.",
                    content = @Content(
                            mediaType = MediaType.APPLICATION_JSON_VALUE,
                            examples = {
    ...
    public ResponseEntity<Object> changePassword(Principal principal, @RequestHeader("X-SIGNATURE") String signature, @RequestBody UserChangePasswordDto userChangePasswordDto);
    ...
    public ResponseEntity<Object> changePin(Principal principal, @RequestHeader("X-SIGNATURE") String signature, @RequestBody UserChangePinDto userChangePinDto);

...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleDataNotFoundException(DataNotFoundException ex) {
        loggingService.catchException(ex, false);
        loggingService.logErrorMessage(ex);
    ...
    public ResponseEntity<Object> handleException(Exception ex) {
        ...
        loggingService.catchException(ex, false);
        loggingService.logErrorMessageWithStackTrace(ex);
    ...
    public ResponseEntity<Object> handleHttpMessageNotReadableException(HttpMessageNotReadableException ex) {
        ...
        if (mostSpecificCause instanceof InvalidFormatException ife) {
            ...
            loggingService.catchException(ex, false, message);
            loggingService.logErrorMessage(ex);
    ...
    public ResponseEntity<Object> handleHttpMediaTypeNotSupportedException(HttpMediaTypeNotSupportedException ex) {
        ...
        return ApiResponseUtil.error(HttpStatus.UNSUPPORTED_MEDIA_TYPE, message);
    }
}